    ...
    $.ajax({
        ...
        success: function (data, textStatus) {
            ...
            for (var key in data.ordersList) {
                ...
                if (data.ordersList[key].realReturnDate === null){
                    div_data += '<td data-field="book_id" style="background-color:#B22222; color: #FFFAFA">' + data.ordersList[key].realReturnDate + '</td>';
                }
...
function loadOrders() {
    ...
    div_data +='<th style="width:20%;" onclick="sortTable(0)">Код</th>';
    div_data +='<th style="width:10%;" onclick="sortTable(1)">Кто выдал</th>';
    div_data +='<th style="width:16%;" onclick="sortTable(0)">Дата выдачи</th>';
    div_data +='<th style="width:16%;" onclick="sortTable(0)">Вернуть до</th>';
    div_data +='<th style="width:16%;" onclick="sortTable(0)">Дата возврата</th>';
