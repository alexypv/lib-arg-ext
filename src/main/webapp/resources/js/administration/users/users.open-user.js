$("#content").on('dblclick', "tr", function () {
    ...
    $.ajax({
        ...
        success: function (data, textStatus) {
            ...
            div_data += '<input type="text" class="form-control" name="ticketNumber" value = "' + data.ticketCode + '" disabled></input>';
			
			div_data += '<label for="ticketNumber">Библиотека</label>  ';
            div_data += '<input type="text" class="form-control" name="ticketNumber" value = "' + data.libraryName + '" disabled></input>';
